...
This is the dated record of the 2026-09-09 run and nothing overwrites it.
[lifecycle-5042002.md](./lifecycle-5042002.md) holds the same run as the latest
and is rewritten every time the runner is used, so a document quoting a figure
from this run should link this file.
